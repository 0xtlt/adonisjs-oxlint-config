...
| `@stylistic/eslint-plugin` + Prettier | Omitted (use Oxfmt or Prettier) |

Formatting is out of scope for Oxlint. Keep Prettier (`@adonisjs/prettier-config`) or switch to [Oxfmt](https://oxc.rs/docs/guide/usage/formatter).
