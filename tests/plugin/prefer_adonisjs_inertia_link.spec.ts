...
runRule('prefer-adonisjs-inertia-link', preferAdonisjsInertiaLink, {
  valid: [
    { name: 'Import Link from @adonisjs/inertia/react', code: `import { Link } from '@adonisjs/inertia/react'` },
    { name: 'Import Link from @adonisjs/inertia/vue', code: `import { Link } from '@adonisjs/inertia/vue'` },
    { name: 'Import other components from @inertiajs/react', code: `import { useForm, usePage } from '@inertiajs/react'` },
    { name: 'Import other components from @inertiajs/vue3', code: `import { useForm, usePage } from '@inertiajs/vue3'` },
