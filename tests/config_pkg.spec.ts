...
import { ADONIS_IGNORE_LIST, DISABLED_CATEGORIES, GLOBAL_IGNORE_LIST, PLUGINS_LIST } from '../src/constants'
...
describe('configPkg', () => {
  ...
  it('ignores the original global and AdonisJS ignore lists', () => {
    expect(configPkg().ignorePatterns).toEqual(expect.arrayContaining([...GLOBAL_IGNORE_LIST, ...ADONIS_IGNORE_LIST]))
  })
