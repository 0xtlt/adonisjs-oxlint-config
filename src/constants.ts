 ...
 */
export const PLUGINS_LIST = ['eslint', 'typescript', 'unicorn', 'oxc', 'node'] as const satisfies NativePlugin[]
...
export const VUE_FILES = ['resources/js/**/*.{ts,vue}', 'inertia/**/*.{ts,vue}', '**/*.vue'] as const
